...
(function($) {
  return $.fn.reportCard = function(options) {
    var ReportCard, Treehouse, th, toThousands;
    ...
    ReportCard = (function() {
      ...
      ReportCard.prototype.build = function(data) {
        ...
        html = "<p>I have completed " + data.badge_count + " lessons and scored " + (toThousands(data.points_total)) + " points at " + data.site + "!</p>\n<ul class=\"badges\">";
